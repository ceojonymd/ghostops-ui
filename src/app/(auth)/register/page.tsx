    ...
    >
      <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-8 shadow-2xl shadow-black/40 backdrop-blur-xl">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className="border-white/[0.08] bg-white/[0.04] pr-10 text-white placeholder:text-zinc-500 focus-visible:border-violet-500/50 focus-visible:ring-violet-500/20"
                required
              />
              <button
                type="button"
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ? "border-violet-500/60 bg-violet-600/10 text-violet-300 shadow-sm shadow-violet-500/10"
                        : "border-white/[0.08] bg-white/[0.02] text-zinc-400 hover:border-white/[0.15] hover:bg-white/[0.04] hover:text-zinc-300"
                    )}
                  >
                    <Icon
                      className={cn(
          ...
          <div className="flex items-start space-x-2">
            <Checkbox
              ...
              className="mt-0.5 border-white/20 data-[state=checked]:border-violet-600 data-[state=checked]:bg-violet-600"
            />
            <Label
              htmlFor="terms"
              className="text-sm font-normal leading-snug text-zinc-400 cursor-pointer"
            >
              I agree to the{" "}
              <Link
                href="/terms"
        ...
        <div className="relative my-6">
          ...
          <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-zinc-950/80 px-3 text-xs text-zinc-500">
            or continue with
          </span>
        </div>
